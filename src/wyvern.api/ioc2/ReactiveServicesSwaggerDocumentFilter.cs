...
namespace wyvern.api.ioc
{
    ...
    /// </summary>
    internal class ReactiveServicesSwaggerDocumentFilter : IDocumentFilter
    {
        IServiceProvider _provider;

        public ReactiveServicesSwaggerDocumentFilter(IServiceProvider provider)
        {
            _provider = provider;
        }
        ...
        public void Apply(SwaggerDocument swaggerDoc, DocumentFilterContext context)
        {
            ...
            foreach (var (serviceType, _) in localServiceTypes.Select(x => (x, _provider.GetService(x))))
            {
